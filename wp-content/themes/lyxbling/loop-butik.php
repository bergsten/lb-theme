 ...
 * Loop - Butik
 *
 * This is a custom loop file, containing the looping logic for use in the "butiker" page template, 
 * as well as the "butik" taxonomy archive screens. The custom query is only run on the page
...
$butik_slugs = array();
foreach ( $butik as $b ) { $butik_slugs[] = $b->slug; }
...
<?php
	...
	if ( is_page() || is_post_type_archive() ) { woo_portfolio_navigation( $butik ); }
?>
